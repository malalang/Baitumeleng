    ...
    <div className="flex flex-col min-h-screen">
      <main className="flex-1">
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              <div>
                ...
                <p className="text-xs md:text-sm text-white uppercase tracking-widest font-bold">Years Experience</p>
              </div>
              <div>
                <p className="text-3xl md:text-4xl font-bold text-accent mb-1">24h</p>
                <p className="text-xs md:text-sm text-white uppercase tracking-widest font-bold">Avg. Turnaround</p>
              </div>
              <div>
                <p className="text-3xl md:text-4xl font-bold text-accent mb-1">100%</p>
                <p className="text-xs md:text-sm text-white uppercase tracking-widest font-bold">Quality Guarantee</p>
              </div>
              <div>
                <p className="text-3xl md:text-4xl font-bold text-accent mb-1">5k+</p>
                <p className="text-xs md:text-sm text-white uppercase tracking-widest font-bold">Happy Clients</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <section className="py-24 bg-background overflow-hidden">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                <h2 className="text-4xl md:text-5xl mb-8 leading-tight text-primary">Why South Africa's Businesses Choose Us</h2>
        ...
        <section id="services" className="py-24 bg-secondary/30 border-y border-border">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <Badge variant="outline" className="mb-4 border-primary text-primary px-4 py-1 font-bold">Administrative Support</Badge>
              <h2 className="text-4xl md:text-5xl mb-6 text-primary">Essential Business Services</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {GENERAL_SERVICES.slice(0, 6).map((service) => (
                <Card key={service.id} className="group hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 border-none shadow-sm bg-white overflow-hidden">
                  ...
                  <CardContent>
                    <p className="text-muted-foreground text-sm line-clamp-2 leading-relaxed font-medium">{service.desc}</p>
                  </CardContent>
              ...
              <div className="order-2 lg:order-1">
                <div className="relative aspect-square max-w-md mx-auto lg:max-w-none">
                  ...
                  <div className="absolute -bottom-10 -right-10 bg-accent text-primary p-8 rounded-3xl shadow-2xl max-w-xs border-4 border-primary">
                    ...
                    <p className="text-xs uppercase tracking-widest font-black opacity-70">Verified Business Customer</p>
                  </div>
                </div>
              </div>
              <div className="order-1 lg:order-2">
                <Badge className="bg-accent text-primary hover:bg-accent mb-6 font-bold uppercase">Advanced Technology</Badge>
                <h2 className="text-4xl md:text-6xl text-white mt-4 mb-8 tracking-tighter font-bold">Digital Printing & Signage</h2>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {PRICING_PACKAGES.map((pkg, index) => (
                <Card key={index} className={`flex flex-col border-2 transition-all ${pkg.popular ? 'border-accent shadow-2xl scale-105 bg-white relative z-10' : 'border-border'}`}>
                  {pkg.popular && (
        ...
        <section className="py-24 bg-secondary/20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-20">
              <h2 className="text-4xl md:text-5xl mb-6 text-primary font-bold">Simple 4-Step Process</h2>
              <p className="text-muted-foreground text-lg leading-relaxed font-medium">How we bring your ideas from concept to reality.</p>
            </div>
        ...
        <section className="py-24 bg-primary text-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl text-white font-bold">What Our Clients Say</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {TESTIMONIALS.map((t, i) => (
                <Card key={i} className="bg-white/5 border-white/10 text-white p-8">
                  <Quote className="h-10 w-10 text-accent mb-6 opacity-50" />
                  <p className="text-lg italic mb-8 leading-relaxed font-medium text-white/90">"{t.content}"</p>
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-accent uppercase font-bold tracking-widest">{t.role}</p>
                    </div>
                  </div>
                </Card>
              ))}
            ...
            <div className="max-w-5xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-0 bg-white rounded-[40px] overflow-hidden shadow-[0_32px_64px_-16px_rgba(0,0,0,0.15)] border">
                <div className="lg:col-span-5 bg-primary p-12 text-white flex flex-col justify-between">
                  <div>
                    <h2 className="text-4xl text-white mb-6 tracking-tighter font-bold">Let's Build Something Great Together</h2>
                    ...
                    <div className="space-y-8">
                      <div className="flex items-start gap-5">
                        ...
                        <div>
                          ...
                          <p className="text-white/70">123 Business Street, Local Mall, Area 45, Pretoria</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-5">
                        <div className="bg-accent p-3 rounded-2xl">
                        ...
                        <div>
                          ...
                          <p className="text-white/70">+27 12 345 6789</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-5">
                        <div className="bg-accent p-3 rounded-2xl">
                        ...
                        <div>
                          ...
                          <p className="text-white/70">Monday - Friday: 08:00 - 18:00</p>
                          <p className="text-white/70">Saturday: 09:00 - 13:00</p>
                        </div>
                      </div>
                    </div>
                  </div>
