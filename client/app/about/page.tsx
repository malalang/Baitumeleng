      ...
      <main className="flex-1">
        ...
        <section className="bg-primary py-24 text-white">
          <div className="container mx-auto px-4 text-center">
            <Badge className="bg-accent text-primary mb-6">Est. 2010</Badge>
          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="relative">
                ...
                />
                <div className="absolute -bottom-8 -right-8 bg-accent p-10 rounded-3xl shadow-xl hidden md:block">
                  <p className="text-primary font-black text-5xl">15+</p>
                  <p className="text-primary/70 font-bold uppercase tracking-widest text-xs">Years of Growth</p>
                </div>
              </div>
              <div className="space-y-8">
                <div className="flex items-center gap-3 text-accent">
                  <History className="h-6 w-6" />
                  <span className="font-black uppercase tracking-[0.2em] text-sm">Our Journey</span>
                </div>
                <h2 className="text-4xl md:text-5xl tracking-tight">From Local Roots to Regional Excellence.</h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-8">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm">Proudly South African and locally operated.</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    <CheckCircle2 className="h-6 w-6 text-accent shrink-0" />
                    <div>
                      ...
                      <p className="text-sm">Implementing sustainable ink and paper practices.</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="py-24 bg-secondary/30 border-y">
          <div className="container mx-auto px-4">
            <div className="text-center mb-20">
              <h2 className="text-4xl md:text-5xl mb-6">Built on Strong Foundations</h2>
              <p className="text-muted-foreground text-lg">The values that drive every decision we make.</p>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="bg-primary rounded-[40px] p-12 md:p-24 text-center text-white relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h2 className="text-4xl md:text-6xl font-bold mb-8">Ready to bring your vision to life?</h2>
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-6">
                  <Button size="lg" className="h-16 px-10 text-lg bg-accent text-primary hover:bg-white font-bold" asChild>
                    <Link href="/#quote">Start Your Quote</Link>
                  </Button>
                  <Button size="lg" variant="outline" className="h-16 px-10 text-lg text-white border-white/20 hover:bg-white/10" asChild>
